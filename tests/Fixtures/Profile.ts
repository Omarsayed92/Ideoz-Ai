...
export class ProfilePage {
    ...
    constructor(page: Page) {
        ...
        // More menu elements
        // Profile icon is a circular button in the header with user's initial
        // Using class-based locator since element has no test ID
        this.profileIcon = page.locator('button.rounded-full.bg-gray-800:has(div.text-white)').first();
    ...
    async verifyMoreSliderElements() {
        ...
        //wait expect(this.ideozPointsSection).toBeVisible();
    }
